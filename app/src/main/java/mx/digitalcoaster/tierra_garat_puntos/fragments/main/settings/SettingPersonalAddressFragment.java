 ...
 */
public class SettingPersonalAddressFragment extends Fragment {
    ...
    public SettingPersonalAddressFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate (R.layout.fragment_setting_personal_address, container, false);

        if(view != null) {
            backBttn = view.findViewById (R.id.backBttn);
            saveBttn = view.findViewById (R.id.saveBttn);
            textView = view.findViewById (R.id.text2);
            textView2 = view.findViewById (R.id.text9);
            editText = view.findViewById (R.id.text10);
            changeFonts ();
    ...
    public void onResume() {
        super.onResume();
        //Analytics
        mTracker.setScreenName("SettingPersonalAddressFragment");
