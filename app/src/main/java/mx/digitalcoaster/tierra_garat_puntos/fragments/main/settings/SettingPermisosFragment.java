 ...
 */
public class SettingPermisosFragment extends Fragment {
    ...
    public SettingPermisosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate (R.layout.fragment_setting_permisos, container, false);
    ...
    public void onResume() {
        super.onResume();
        //Analytics
        mTracker.setScreenName("SettingPermisosFragment");
